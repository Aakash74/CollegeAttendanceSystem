package com.example.attendencesystem.activity;
...
import com.example.attendencesystem.R;
import com.example.attendencesystem.bean.AttendanceBean;
import com.example.attendencesystem.bean.AttendanceSessionBean;
import com.example.attendencesystem.bean.FacultyBean;
import com.example.attendencesystem.bean.StudentBean;
import com.example.attendencesystem.context.ApplicationContext;
...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private final String[] yearString = new String[] {"SE","TE","BE"};
	private final String[] subjectSEString = new String[] {"SC","MC"};
	private final String[] subjectTEString = new String[] {"GT","CN"};
	private final String[] subjectBEString = new String[] {"DS","NS"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewTotalAttendance.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ArrayList<AttendanceBean> attendanceBean = dbAdapter.getTotalAttendanceBySessionID(attendanceSessionBean);
				((ApplicationContext)AddAttandanceSessionActivity.this.getApplicationContext()).setAttendanceBeanList(attendanceBean);
	...
	public String[] getSubjectSEString() {
		return subjectSEString;
	}

	public String[] getSubjectTEString() {
		return subjectTEString;
	}

	public String[] getSubjectBEString() {
		return subjectBEString;
	}
}
