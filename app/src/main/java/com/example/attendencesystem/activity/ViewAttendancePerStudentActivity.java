...
import com.example.attendencesystem.db.DBAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for(AttendanceBean attendanceBean : attendanceBeanList)
		{
			String users = "";
				...
				users = attendanceBean.getAttendance_student_id()+".     "+ ((StudentBean) studentBean).getStudent_firstname()+","+studentBean.getStudent_lastname()+"                  "+attendanceBean.getAttendance_session_id();
